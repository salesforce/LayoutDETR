...
def generate_images(
    ...
    for seed in seeds:
        ...
        bbox_fake_raw_list.append(bbox_fake[0])
    ...
    ###################################
    # Here I only process overlap ranked banners, feel free to add alignment based ordering
    ...
    for j, idx in enumerate(order):
        ...
        save_bboxes_with_background(bbox_fake_raw_list[idx], mask_list[idx], bbox_class_list[idx], background_orig, outfile+'_bboxes.png')
